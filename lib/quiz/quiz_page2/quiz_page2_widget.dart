...
class QuizPage2Widget extends StatefulWidget {
  const QuizPage2Widget({super.key});

  static String routeName = 'QuizPage2';
  static String routePath = '/quizPage2';

  @override
  State<QuizPage2Widget> createState() => _QuizPage2WidgetState();
}
